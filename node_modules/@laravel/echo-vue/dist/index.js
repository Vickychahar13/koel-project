import { ref as b, onMounted as y, onUnmounted as _, watch as P } from "vue";
...
class w extends I {
   ...
   */
  channel(e) {
    return this.channels[e] || (this.channels[e] = new S(
      this.pusher,
      e,
      this.options
    )), this.channels[e];
...
class W {
  ...
  connectorSupportsEncryptedPrivateChannels(e) {
    return e instanceof w || e instanceof R;
  }
  /**
   * Get the Socket ID for the connection.
   */
...
const Y = () => {
  ...
  return u.Pusher ?? (u.Pusher = H), p = new W(u), p;
}, Z = () => u !== null, ee = (n) => {
  u = {
    ...{
      reverb: {
...
}, m = () => Y(), F = (n) => Array.isArray(n) ? n : [n], h = {}, z = (n) => {
  if (h[n.id])
  ...
  h[n.id] && (h[n.id].count -= 1, !(h[n.id].count > 0) && (delete h[n.id], e ? m().leave(n.name) : m().leaveChannel(n.id)));
};
function k(n, e = [], t = () => {
}, s = [], i = "private") {
  const r = b(t), c = b(!1);
...
const te = (n, e = () => {
  ...
  const i = k(
    ...
    s,
    "private"
  ), r = F(t).map((o) => o.includes(".") ? [o, o.replace(/\./g, "\\")] : [o, o.replace(/\\/g, ".")]).flat(), c = b(!1), d = b(!1), l = (o) => {
    c.value && (r.length === 0 || r.includes(o.type)) && e(o);
  }, f = () => {
    c.value || (d.value || i.channel().notification(l), c.value = !0, d.value = !0);
  }, v = () => {
    c.value && (i.channel().stopListeningForNotification(l), c.value = !1);
  };
  return y(() => {
    f();
  }), _(() => {
  ...
  const n = b(m().connectionStatus());
  let e;
  return y(() => {
    e = m().connector.onConnectionChange((t) => {
      n.value = t;
    });
  }), _(() => {
    e == null || e();
